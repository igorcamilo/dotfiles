...
hl.config({
    input = {
        kb_layout = "us", -- Change this if the keyboard isn't a US layout.
    },
})
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("systemctl --user start quickshell-launcher.service"))
hl.bind(mainMod .. " + P", hl.dsp.window.pseudo())
hl.bind(mainMod .. " + J", hl.dsp.layout("togglesplit")) -- dwindle only
hl.bind(mainMod .. " + L", hl.dsp.exec_cmd("systemctl --user start quickshell-lock.service"))
...
-- Move the focused window to a workspace with mainMod + SHIFT + [0-9]
for i = 1, 10 do
