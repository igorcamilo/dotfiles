...
run inside the NixOS ARM live environment or installed guest. The first
`flake.lock` can also be generated by the repository's manual, read-only ARM
workflow; see [Fresh installation](docs/install.md).
